...
//            setLoadingTextColor(R.color.white)
    ...
    private fun initRecyclerView() {
        ...
        binding.recyclerView.run {
            ...
            mLayoutManager.spanSizeLookup = object : androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup() {
                override fun getSpanSize(position: Int): Int =
                    if (mLayoutManager.spanCount > 1 && mAdapter.getItem(position) is MangaPage) 1
                    else mLayoutManager.spanCount
            }
    ...
    private fun setScrollMode(mode: Int) {
        ...
        val isDoublePage = mode == MangaScrollMode.DOUBLE_PAGE_LEFT_TO_RIGHT ||
                mode == MangaScrollMode.DOUBLE_PAGE_RIGHT_TO_LEFT
        val useTwoPages = isDoublePage &&
        ...
        when (mode) {
            ...
            MangaScrollMode.DOUBLE_PAGE_LEFT_TO_RIGHT,
            MangaScrollMode.DOUBLE_PAGE_RIGHT_TO_LEFT,
        ...
        mLayoutManager.spanCount = if (useTwoPages) 2 else 1
        binding.recyclerView.layoutDirection = if (
            mode == MangaScrollMode.DOUBLE_PAGE_RIGHT_TO_LEFT
        ) View.LAYOUT_DIRECTION_RTL else View.LAYOUT_DIRECTION_LTR

        mAdapter.isHorizontal = isHorizontalPage || isDoublePage ||
                mode == MangaScrollMode.PAGE_TOP_TO_BOTTOM
