...
fun BookshelfScreen(
    ...
    onNavigateToSearch: (String, BookshelfSection) -> Unit,
    ...
    val onSearchClick = {
        if (BookshelfConfig.bookshelfSearchActionDirectToSearchState.value) {
            onNavigateToSearch(uiState.searchKey.trim(), uiState.selectedSection)
        } else {
            ...
            BookshelfTopBar(
                ...
                onSearchSubmit = { rawQuery ->
                    rawQuery.trim()
                        ...
                        ?.let { onNavigateToSearch(it, uiState.selectedSection) }
                },
                ...
                bottomContent = {
                    Row(
                        ...
                        AppTabRow(
                            tabTitles = sectionTitles,
                            selectedTabIndex = uiState.selectedSection.ordinal,
                            onTabSelected = { index ->
                                viewModel.changeSection(BookshelfSection.values()[index])
                            },
