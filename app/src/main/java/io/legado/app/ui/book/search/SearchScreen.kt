        ...
        topBar = {
            Column {
                GlassMediumFlexibleTopAppBar(
                    ...
                    actions = {
                        if (state.results.any { it.shelfState == BookShelfState.NOT_IN_SHELF }) {
                            TopBarAnimatedActionButton(
                                checked = false,
                                onCheckedChange = {
                                    viewModel.onIntent(SearchIntent.AddAllResultsToBookshelf)
                                },
                                iconChecked = Icons.AutoMirrored.Filled.LibraryBooks,
                                iconUnchecked = Icons.AutoMirrored.Filled.LibraryBooks,
                                activeText = stringResource(R.string.add_all_to_bookshelf),
                                inactiveText = stringResource(R.string.add_all_to_bookshelf),
                            )
                        }
                        TopBarAnimatedActionButton(
        ...
        Column(
            ...
            Column(
                ...
                listOf(
                    ...
                    4 to stringResource(R.string.anime),
                ).forEach { (type, label) ->
                    SelectionItemCard(
                        title = label,
