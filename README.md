...
**阅读DD** 是基于开源项目 [阅读 (Legado)](https://github.com/gedoor/legado) 和
[Legado with MD3](https://github.com/HapeLee/legado-with-MD3) 修改的个人阅读应用。
书架和发现页按小说、漫画、动漫三个板块组织，并加强了书源导入检测、分类搜索、漫画阅读与视频播放体验。
